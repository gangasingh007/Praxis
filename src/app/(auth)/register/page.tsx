  ...
  return (
    <div className="min-h-screen flex items-center justify-center  relative px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none">
        <div className="absolute inset-0 bg-[radial-gradient(#3f3f46_1px,transparent_1px)] [background-size:28px_28px] [mask-image:radial-gradient(ellipse_60%_60%_at_50%_50%,#000_60%,transparent_100%)] opacity-55 dark:opacity-95"></div>
        {/* <div className="absolute top-[-15%] right-[-10%] w-[600px] h-[600px] bg-primary/10 blur-[130px] rounded-full animate-pulse" /> */}
        <div className="absolute bottom-[-15%] left-[-10%] w-[700px] h-[700px] blur-[140px] rounded-full"></div>
      ...
      <div className="w-full max-w-[420px] space-y-6 relative">
        ...
        >
          ...
          <div>
            <h1 className="italic text-5xl font-black tracking-tighter uppercase">
              Praxis
              ...
              <form action={handleSubmit} className="space-y-6">
                <div className="space-y-1 mb-2">
                  ...
                  <p className="text-xs font-mono text-muted-foreground/50 uppercase tracking-widest">
                    Enter your credentials to enlist
                  </p>
                </div>
                    ...
                    {nameValue && (
                      <span
                        className={cn(
                          ...
                          nameValid ? "text-emerald-400" : "text-rose-400/70"
                        )}
                      >
                  ...
                  >
                    ...
                    <Input
                      ...
                      className={cn(
                        ...
                        nameValue && nameValid && "border-emerald-500/30",
                        nameValue && !nameValid && "border-rose-500/20"
                      )}
                    />
                    {nameValue && (
                ...
                <button
                  ...
                  className="w-full h-11 rounded-xl border border-border/40 bg-background/20 hover:bg-background/40 hover:border-border/60 transition-all duration-300 flex items-center justify-center gap-2 text-xs font-mono uppercase tracking-widest text-muted-foreground hover:text-foreground disabled:opacity-50 disabled:pointer-events-none"
                >
                  {isLoadingGoogle ? (
                  ...
                  {isLoadingGoogle ? "Initializing..." : "Continue with Google"}
                </button>
              </form>
            )}
          </div>
        ...
        >
          ...
          <p className="text-center text-[10px] font-mono text-muted-foreground/30 uppercase tracking-[0.3em]">
            Praxis OS v0.1.0{" "}
            <span className="text-primary/50 mx-1">///</span> Secure Enrollment
          </p>
        </div>
      </div>
